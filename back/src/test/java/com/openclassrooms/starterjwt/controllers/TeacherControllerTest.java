...
public class TeacherControllerTest {
    ...
    // MockMvc pour simuler les appels HTTP sur le contrôleur
    ...
    // Services et mappers du contrôleur simulés avec @MockBean
    @MockBean
    ...
    // Préparation des objets de test avant chaque méthode
    @BeforeEach
    public void setup() {
        ...
        // DTO correspondant à l’enseignant
        ...
        // Deuxième enseignant pour tester les listes
        ...
        // DTO correspondant au second enseignant
    ...
    // Test GET /api/teacher/{id} - succès
    @Test
    ...
    // Test GET /api/teacher/{id} - enseignant non trouvé
    @Test
    ...
    // Test GET /api/teacher/{id} - ID invalide (non numérique)
    @Test
    ...
    // Test GET /api/teacher - récupération de tous les enseignants
    @Test
    ...
    // Test GET /api/teacher - liste vide
    @Test
